...
<body class="horizontal-layout horizontal-menu horizontal-menu-padding material-horizontal-layout material-layout 2-columns  " data-open="click" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table id="idTablePedidos" class="table table-de mb-0">
                                        <thead>
                                            <tr>
                                                <th>Cliente</th>
                                                <th>Valor Pedido</th>
    ...
    <!-- END: Content-->
    <div class="modal fade" id="idModalPedidos" data-idcliente="" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="true"></div>
